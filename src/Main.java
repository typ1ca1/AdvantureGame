...
public class Main {
    public static void main(String[] args) {
        ...
        Ogre greenOgre = new Ogre("Green Ogre", 30, 25, "Color is green");
        Ogre redOgre = new Ogre("Red Ogre", 35, 30, "Color is green");
        Zombie slowZombie = new Zombie("Slow Zombie", 20, 35, 5);
        Zombie fastZombie = new Zombie("Fast Zombie", 50, 10, 20);
        Dog spotDog = new Dog("Spot Dog", 20, 15, "Dog is tamed");
